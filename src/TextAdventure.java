...
public class TextAdventure {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"You wake up in a Penthouse of a skyscraper in NY. The Soviets have attacked the US over Trump-Putin memes. \n"
		...
		System.out.println(
				"It's too late now. The Soviets just dropped the biggest nuclear bomb. Even before you realize it, you've been vaporized.");
		in.close();
	}
}
