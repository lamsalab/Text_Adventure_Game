...
public class Vodka implements Items {
	...
	@Override
	public void pickup() {
		System.out.println("Even in this situation you are not going to miss out on a free drink." + "You pick up the"
				+ this.getName());
	...
	@Override
	public void drop() {
		System.out.println("You decide now is probably not a good time for a drink and drop the bottle of "
				+ this.getName() + ". Smart move!");
	}
